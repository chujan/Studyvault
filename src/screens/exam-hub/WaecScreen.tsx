  ...
  return (
    <Block flex={1} style={styles.container}>
      ...
      >
        ...
        <Text style={styles.headerTitle}>WAEC</Text>
      </Block>
      ...
      >
        ...
        <Block style={styles.newsCard}>
          <Text style={styles.newsTitle}>
            Prepare for WASSCE with a realistic CBT platform tailored to your needs.
          </Text>
        </Block>
        ...
        <Block style={[styles.proceedWrapper, { paddingBottom: insets.bottom }]}>
          <TouchableOpacity
            ...
            onPress={() =>
              navigation.navigate('WaecPracticeScreen', {
